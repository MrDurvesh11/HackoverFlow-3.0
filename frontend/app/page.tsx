...
export default function Dashboard() {
  ...
  //       // Show welcome modal if it's the first login (simulated)
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col h-full items-center justify-center">
        ...
        <div className="text-xl font-medium">Loading TradeSense_Ai...</div>
        <div className="text-sm text-muted-foreground mt-2">Fetching market data and portfolio information</div>
      </div>
    )
  }
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        ...
        <Card className="bg-gradient-card border-border/40 hover:shadow-md transition-shadow duration-300">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button variant="outline" size="sm" className="gap-1" onClick={() => router.push("/portfolio")}>
